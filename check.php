...
<html lang="en">
	...
	<body>
		<section>
			...
			<ul class="details">
				<?php foreach($unusableOptionalExtensions as $extension => $class): ?>
			...
			<ul class="details">
				...
				<?php endif; ?>
				<?php if(!$useAllRequiredExtensions): ?>
